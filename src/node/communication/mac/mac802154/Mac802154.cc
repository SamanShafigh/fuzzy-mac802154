...
void Mac802154::transmitNextPacket()
{
	...
	if (nextPacket->getMac802154PacketType() == MAC_802154_DATA_PACKET && nodeSendDataPacketDuringCAP){
		numberOfPacketSentCAP_MACMACa++;
	}

	if (nextPacket->getMac802154PacketType() == MAC_802154_DATA_PACKET && nodeSendDataPacketDuringCFP){
...
void Mac802154::openFile(ofstream& myfile, string folderName){
	std::string nodeId;
